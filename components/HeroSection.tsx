...
const HeroSection: React.FC<HeroSectionProps> = ({ onNavigate }) => {
    ...
    const RadialTimer = () => (
        <div className="relative w-14 h-14 transition-transform hover:scale-110">
    ...
    return (
        ...
        >
            ...
            {slides.length > 1 && (
                <div className="absolute top-8 left-6 sm:left-12 lg:left-20 z-30 pointer-events-none">
                    <RadialTimer />
                </div>
            )}
